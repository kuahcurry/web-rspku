...
// Public routes
Route::post('/register', [RegisterController::class, 'register'])->middleware('progressive_throttle:register');
Route::post('/login', [AuthController::class, 'login'])->middleware('progressive_throttle:login');
Route::post('/verify-email', [RegisterController::class, 'verifyEmail'])->middleware('progressive_throttle:verify-email');
Route::post('/resend-verification-code', [RegisterController::class, 'resendVerificationCode'])->middleware('progressive_throttle:resend-verification-code');

// Password Reset routes
Route::post('/forgot-password', [PasswordResetController::class, 'forgotPassword'])->middleware('progressive_throttle:forgot-password');
Route::post('/verify-reset-code', [PasswordResetController::class, 'verifyResetCode'])->middleware('progressive_throttle:verify-reset-code');
Route::post('/reset-password', [PasswordResetController::class, 'resetPassword'])->middleware('progressive_throttle:reset-password');
