  ...
  const handleProfileSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        tanggal_lahir: profileData.birthDate || user?.tanggal_lahir || '',
        ...
        tanggal_mulai_kerja: profileData.tanggalMulaiBekerja || user?.tanggal_mulai_kerja || '',
      };
      ...
      if (response.ok && data.success) {
        ...
        // Update form with latest user data so date fields stay filled
        if (data.data) {
          setProfileData((prev) => ({
            ...prev,
            birthDate: data.data.tanggal_lahir || prev.birthDate,
            tanggalMulaiBekerja: data.data.tanggal_mulai_kerja || prev.tanggalMulaiBekerja,
          }));
        }
