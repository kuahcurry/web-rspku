...
const Faq = () => {
  ...
  const categories = [
    ...
    { id: 'penugasan', label: 'Pekerjaan', icon: MdAssignment },
...
Prestasi akan ditampilkan di profil Anda.`
    ...
    // Penugasan
    {
      id: 12,
      category: 'penugasan',
      question: 'Bagaimana cara menambah riwayat pekerjaan?',
      answer: `Untuk menambah riwayat pekerjaan:

1. Buka halaman **Pekerjaan** dari menu sidebar
2. Pilih tab yang sesuai (Pekerjaan/Pengabdian)
3. Klik tombol **Tambah**
4. Isi formulir:
        ...
        <Card className={styles.helpCard}>
          <div className={styles.helpContent}>
            ...
            <div className={styles.helpContact}>
              <p><strong>Email Bantuan 1:</strong> tbot691@gmail.com</p>
              <p><strong>Email Bantuan 2:</strong> dzakaal10@gmail.com</p>
            </div>
          </div>
        </Card>
      </div>
