          ...
          <div className={styles['progress-grid']}>
            <Card variant='secondary' padding="normal">
              <div className={styles['progress-item']}>
                ...
                <progress className={`${styles['progress-native']} ${styles.success}`} value="100" max="100" />
              </div>
            </Card>
            ...
            <Card variant='secondary' padding="normal">
              <div className={styles['progress-item']}>
                ...
                <progress className={`${styles['progress-native']} ${styles.danger}`} value="15" max="100" />
              </div>
            </Card>
            ...
            <Card variant='secondary' padding="normal">
              <div className={styles['progress-item']}>
                ...
                <progress className={`${styles['progress-native']} ${styles.warning}`} value="90" max="100" />
              </div>
            </Card>
            ...
            <Card variant='secondary' padding="normal">
              <div className={styles['progress-item']}>
                ...
                <progress className={`${styles['progress-native']} ${styles.warning}`} value="75" max="100" />
              </div>
            </Card>
