...
const PengajuanKredensial = lazy(() => import("./pages/main/pengajuan/PengajuanKredensial"));
...
const AdminPengajuanKredensial = lazy(() => import("./pages/admin/pengajuan/AdminPengajuanKredensial"));
...
const BackupManajemen = lazy(() => import("./pages/admin/pengaturan/BackupManajemen"));
const MaintenanceControl = lazy(() => import("./pages/admin/pengaturan/MaintenanceControl"));
    ...
    <Router>
      <UserProvider>
        <Suspense fallback={<LoadingFallback />}>
          ...
          <Routes>
            {/* Auth Routes */}
            <Route path="/" element={isAdminSubdomain ? (
              <RecaptchaProvider><LoginAdmin /></RecaptchaProvider>
            ) : (
              <RecaptchaProvider><LoginUser /></RecaptchaProvider>
            )} />
            <Route path="/login" element={isAdminSubdomain ? (
              <RecaptchaProvider><LoginAdmin /></RecaptchaProvider>
            ) : (
              <RecaptchaProvider><LoginUser /></RecaptchaProvider>
            )} />
            <Route path="/register" element={<RecaptchaProvider><Register /></RecaptchaProvider>} />
        ...
        />
        <Route 
          path="/admin/pengajuan-kredensial" 
          element={
            <ProtectedAdminRoute>
              <AdminPengajuanKredensial />
            </ProtectedAdminRoute>
          }
        />
        <Route 
        ...
        />
        {/* Routes for Tambah/Edit pengajuan removed — functionality moved into modals in PengajuanKredensial */}
        <Route
